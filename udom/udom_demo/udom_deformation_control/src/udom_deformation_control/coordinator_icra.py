...
class Coordinator(object):
    ...
    def __init__(self):
        ...
        self.wrench_filter_status = None
        ...
        self.start_wrench_filter = rospy.Publisher(
            "~start_wrench_filter", std_msgs.msg.String, queue_size=10, latch=True)
        ...
        rospy.Subscriber(
            "~wrench_filter_status", std_msgs.msg.String, self.wrench_filter_status_cb)
        rospy.Subscriber(
        ...
        rospy.Subscriber(
            "~topic_throttle_status", std_msgs.msg.String, self.topic_throttle_status_cb)
        rospy.Subscriber(
    ...
    def wrench_filter_status_cb(self, msg):
        """
        Obtains the status of the component (as an event).
    ...
    def toggle_components(self, event):
        ...
        if event == 'e_stop':
            ...
            self.start_wrench_filter.publish('e_stop')
        ...
        if event == 'e_start' and not self.started_components:
            ...
            self.start_wrench_filter.publish('e_start')
